...
import { Button, Card, Table, Container, Row, Col, Form, Tabs, Tab, Spinner } from "react-bootstrap";
...
export default class FairDetail extends React.Component
{
  ...
  componentWillMount()
  {
    console.log(`${fairDescription}${this.state.id}`);
  ...
  render()
  {
    ...
    let {fairInfo, ideas, key} = this.state;
      ...
      return (
          ...
          <Container fluid>
            ...
            <Tabs
              ...
              { fairInfo ? (<div className="jumbotron">
                  <Row>
                    ...
                    <Card className="card-stats bg-gray m-1 p-2">
                      ...
                      <Card.Body>
                        <Row>
                          <Col xs="12">
                            <div>
                              <h4 className="txt-darkblue">{fairInfo.name}</h4>
                                <h2  className="txt-darkblue">{fairInfo.description}</h2>
                            </div>
                          </Col>
                        </Row>
                      </Card.Body>
                      ...
                      <Row className="bg-gray btn-rounded p-2 m-2">
                        ...
                        <Col>
                          <div className="txt-blue m-2" id="FechaInicioFeria">
                            {moment(fairInfo.star_date).format('MMMM Do YYYY, h:mm:ss a')}
                          </div>
                        </Col>
                      </Row>
                      ...
                      <Row className="bg-gray btn-rounded p-2 m-2">
                        ...
                        <Col>
                          <div className="txt-blue m-2" id="FechaFinalFeria">
                            {moment(fairInfo.end_date).format('MMMM Do YYYY, h:mm:ss a')}}
                          </div>
                        </Col>
                      </Row>
                      <Row className="bg-gray btn-rounded p-2 m-2">
                  ...
                  </div>) : (<div className="text-align-center"><Spinner animation="grow" variant="primary"/></div>)
                }
              </Tab>
